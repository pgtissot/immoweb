...
<head>
	<meta charset="utf-8" />
	<meta name="description" content="Saga Home - real estate template project">
...
<div class="col-lg-6 offset-lg-3">		
	...
	<form action="php/form.php" method="POST" name="depot">					
        <!---Adv1 Advertisement--->
